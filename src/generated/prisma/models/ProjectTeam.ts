...
export type ProjectTeamWhereInput = {
  ...
  created_at?: Prisma.DateTimeFilter<"ProjectTeam"> | Date | string
  updated_at?: Prisma.DateTimeFilter<"ProjectTeam"> | Date | string
...
export type ProjectTeamScalarWhereWithAggregatesInput = {
  ...
  created_at?: Prisma.DateTimeWithAggregatesFilter<"ProjectTeam"> | Date | string
  updated_at?: Prisma.DateTimeWithAggregatesFilter<"ProjectTeam"> | Date | string
  ...
  permission?: Prisma.EnumProjectTeamPermissionWithAggregatesFilter<"ProjectTeam"> | $Enums.ProjectTeamPermission
}
...
export type ProjectTeamCreateInput = {
  ...
  permission?: $Enums.ProjectTeamPermission
  Project: Prisma.ProjectCreateNestedOneWithoutProjectTeamInput
  Team: Prisma.TeamCreateNestedOneWithoutProjectTeamInput
}
...
export type ProjectTeamUpdateInput = {
  ...
  Project?: Prisma.ProjectUpdateOneRequiredWithoutProjectTeamNestedInput
  Team?: Prisma.TeamUpdateOneRequiredWithoutProjectTeamNestedInput
}
...
export type ProjectTeamOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"created_at" | "updated_at" | "projectId" | "teamId" | "permission", ExtArgs["result"]["projectTeam"]>
...
export interface ProjectTeamDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * const projectTeamWithCreated_atOnly = await prisma.projectTeam.findMany({ select: { created_at: true } })
   * 
   */
   ...
   * })
   * 
   * // Create many ProjectTeams and only return the `created_at`
   * const projectTeamWithCreated_atOnly = await prisma.projectTeam.createManyAndReturn({
   ...
   * })
   * 
   * // Update zero or more ProjectTeams and only return the `created_at`
   * const projectTeamWithCreated_atOnly = await prisma.projectTeam.updateManyAndReturn({
   *   select: { created_at: true },
   *   where: {
   *     // ... provide filter here
   *   },
...
export interface ProjectTeamFieldRefs {
  readonly created_at: Prisma.FieldRef<"ProjectTeam", 'DateTime'>
  readonly updated_at: Prisma.FieldRef<"ProjectTeam", 'DateTime'>
